...
from apps.fyle.helpers import add_expense_id_to_expense_group_settings, add_ccc_credits_flag_to_expense_group_settings
...
def run_post_configration_triggers(sender, instance: Configuration, **kwargs):
    ...
    if instance.corporate_credit_card_expenses_object == 'EXPENSE REPORT':
        add_ccc_credits_flag_to_expense_group_settings(int(instance.workspace_id))
