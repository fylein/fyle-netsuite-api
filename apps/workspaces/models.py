...
class WorkspaceSchedule(models.Model):
    ...
    errors = models.IntegerField(null=True, help_text='Number of errors in export')
    added_emails = JSONField(default=list, help_text='Email and Name of person to send email', null=True)
    selected_email = ArrayField(base_field=models.CharField(max_length=255), null=True, help_text='File IDs')
