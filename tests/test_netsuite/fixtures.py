    ...
    "expense_report_payload": [
        {
            ...
            'expenseList': [{
                ...
                'line': None,
                'memo': 'Expense by ashwin.t@fyle.in against category Accounts Payable spent on 2021-11-15 with report number - C/2021/11/R/5',
                'quantity': None,
                'rate': None,
                'receipt': None,
                'refNumber': None,
    ...
    'bill_payload': [
        {
            ...
            'expenseList': [{
                ...
                'amount': 100.0,
                'memo': 'Expense by ashwin.t@fyle.in against category Accounts Payable spent on 2021-11-15 with report number - C/2021/11/R/6',
                'grossAmt': 100.0,
                'taxDetailsReference': None,
                'department': {
                    'name': None,
    ...
    'journal_entry_without_single_line': [
        {
            ...
            'lineList': [{
                ...
                'lineTaxCode': None,
                'lineTaxRate': None,
                'memo': 'Expense by admin1@fyleforintacct.in against category Food spent on 2021-12-03 with report number - C/2021/12/R/1',
                'residual': None,
