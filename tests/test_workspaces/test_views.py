...
from apps.workspaces.models import Configuration, FyleCredential, LastExportDetail, NetSuiteCredentials, WorkspaceSchedule
...
@pytest.mark.django_db(databases=['default'])
def test_last_export_detail_view(mocker, db, api_client, access_token):
